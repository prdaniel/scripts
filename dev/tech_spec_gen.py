...
properties = open("tmp/properties.csv", "w")
...
dimensions = open("tmp/dimensions.csv", "w")
...
propertyMapper = open("tmp/propertyMapper.csv", "w")
...
dimensionGroups = open("tmp/dimensionGroups.csv", "w")
...
recordFilter = open("tmp/recordFilter.csv", "w")
...
searchInterfaces = open("tmp/searchInterfaces.csv", "w")
...
relevanceRanking = open("tmp/relevanceRanking.csv", "w")
for line in file:
...
file = open("pipeline.epx", "r")
recordAdapters = open('tmp/recordAdapters.csv','w')
...
#Get Data Files
file = open("tmp/recordAdapters.csv", "r")
dataFilesViews = open('tmp/dataFilesViews.csv','w')
list = []
list2 = []
for line in file:
...
file = open("pipeline.epx", "r")
recordManipulators = open('tmp/recordManipulatorsTmp.csv','w')
...
lines_seen = set()
outfile = open('tmp/recordManipulators.csv', "w")
for line in open('tmp/recordManipulatorsTmp.csv', "r"):
    if line not in lines_seen:
        outfile.write(line)
        lines_seen.add(line)
    else:
        pass
os.remove('tmp/recordManipulatorsTmp.csv')
outfile.close()

#Get the Java Manipulators
file = open("pipeline.epx", "r")
javaManipulators = open('tmp/javaManipulators.csv','w')
...
file = open("pipeline.epx", "r")
recordAssembler = open('tmp/recordAssembler.csv','w')
...
wildcarding = open('tmp/wildcarding.csv','w')
...
rollups = open('tmp/rollups.csv','w')
for line in file:
...
sorting = open('tmp/sorting.csv','w')
for line in file:

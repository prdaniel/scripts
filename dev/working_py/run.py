...
options.app_id = 'Discover'
options.client_name = 'Discover'
options.app_directory = 'C:/Endeca/apps/Discover'
...
app.sendemail(from_addr    = 'dkennedy@thanxmedia.com', 
                to_addr_list = ['dkenned23@gmail.com'],
                cc_addr_list = [''],
                reply_to_addr ='dkennedy@thanxmedia.com', 
